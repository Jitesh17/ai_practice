...
# %%
%%time
learner = PPO.load("random_ppo_01")
...
# %%
get_win_percentages(agent1=testagent, agent2=agent_r)

# %%
env = make("connectx", debug=True)

# Two random agents play one game round
env.run([testagent, agent_r])
...
# %%
get_win_percentages(agent1=agent, agent2=agent_r)
# %%
env = make("connectx", debug=True)

# Two random agents play one game round
env.run([agent, agent_r])
